            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    @if(Auth::user()->hasRole('GymManager'))
                        <img src="{{Storage::url(Auth::user()->gymManager->avatar_path)}}"
                             class="img-circle elevation-2" alt="User Image">
                    @elseif(Auth::user()->hasRole('CityManager'))
                        <img src="{{Storage::url(Auth::user()->cityManager->avatar_path)}}"
                             class="img-circle elevation-2" alt="User Image">
                    @else
                        <img src="{{Storage::url(env('DEFAULT_AVATAR'))}}" class="img-circle elevation-2"
                             alt="User Image">
                    @endif
                </div>
                <div class="info">
