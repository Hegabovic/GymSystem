...
@section('content')
    ...
    <form method="post" action="{{route('packages.update',$package->id)}}">
        ...
        <div class="mb-3">
            ...
            <input name="name" value="{{ $package['name'] }}" type="text" class="form-control"
                   id="exampleFormControlInput1" placeholder="">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Price</label>
            <input name="price" value="{{ $package['price'] }}" type="number" class="form-control"
                   id="exampleFormControlInput1" placeholder="">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Number of sessions</label>
            <input name="number_of_sessions" value="{{ $package['number_of_sessions'] }}" type="number"
