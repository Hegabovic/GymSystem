                    ...
                    <table class="table table-bordered" style="color: black;" id="datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a role="button" href="{{route('customers.edit',[$customer->id])}}" class="btn btn-primary m-1 d-inline-block" data-id="{{$customer->id}}">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <a role="button" class="btn btn-danger m-1 d-inline-block delete" data-id="{{$customer->id}}">
